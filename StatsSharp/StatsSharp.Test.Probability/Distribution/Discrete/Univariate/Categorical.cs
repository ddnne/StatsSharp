...
namespace StatsSharp.Test.Probability.Distribution.Discrete.Univariate
{
    ...
    public class Categorical
    {
        ...
        {
            var cat = new StatsSharp.Probability.Distribution.Discrete.Univariate.Categorical();
            ...
            foreach (var id in Enumerable.Range(0, probs.Count()))
            {
                ...
                var parameter = new StatsSharp.Probability.Parameter.Discrete.Univariate.Categorical(probs);
