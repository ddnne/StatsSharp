...
namespace StatsSharp.Test.Probability.Distribution.Continuous.Vector
{
    [TestClass]
    public class MultivariateNormal
    {
        ...
        public void TestLikelihoodFunction()
        {
            ...
            var parameter = new StatsSharp.Probability.Parameter.Continuous.Vector.MultivariateNormal(mean, sigma);
