...
namespace StatsSharp.Test.Probability.Distribution.Continuous.Scalar
{
    ...
    public class Weibull
    {
        ...
        public void TestLikelihoodFunction()
        {
            ...
            var parameter = new StatsSharp.Probability.Parameter.Continuous.Scalar.Weibull(shape, scale);
        ...
        public void TestMaxValueProbabilityDensityFunction()
        {
            ...
            var largeShapeParameter = new StatsSharp.Probability.Parameter.Continuous.Scalar.Weibull(largeShape, scale);
