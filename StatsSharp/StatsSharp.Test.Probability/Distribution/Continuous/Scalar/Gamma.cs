...
namespace StatsSharp.Test.Probability.Distribution.Continuous.Scalar
{
    ...
    public class Gamma
    {
        ...
        public void TestLikelihoodFunction()
        {
            ...
            var parameter = new StatsSharp.Probability.Parameter.Continuous.Scalar.Gamma(k, theta);
        ...
        public void TestMaxValueProbabilityDensityFunction()
        {
            ...
            var k = 2;
            var theta = 1;
            var kGt1Case = new StatsSharp.Probability.Parameter.Continuous.Scalar.Gamma(k, theta);
            Assert.AreEqual(Math.Exp(-1.0), Gamma.GetMaxValueProbabilityDensityFunction(kGt1Case), 1.0e-10);

            var kLt1Case = new StatsSharp.Probability.Parameter.Continuous.Scalar.Gamma(0.5, theta);
