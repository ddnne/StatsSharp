...
namespace StatsSharp.Test.Probability.Parameter.Continuous.Scalar
{
    ...
    public class Normal
    {
        ...
        public void TestConstructor()
        {
            ...
            var normalParameter = new StatsSharp.Probability.Parameter.Continuous.Scalar.Normal(mean, sd);
        ...
        public void TestMinusStandardDeviation()
        {
            ...
            var unifParameter = new StatsSharp.Probability.Parameter.Continuous.Scalar.Normal(mean, sd);
        }
    }
}
