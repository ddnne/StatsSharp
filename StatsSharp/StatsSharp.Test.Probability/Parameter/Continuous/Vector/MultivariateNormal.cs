...
namespace StatsSharp.Test.Probability.Parameter.Continuous.Vector
{
    [TestClass]
    public class MultivariateNormal
    {
        ...
        public void TestConstructor()
        {
            ...
            var normalParameter = new StatsSharp.Probability.Parameter.Continuous.Vector.MultivariateNormal(mean, sd);
