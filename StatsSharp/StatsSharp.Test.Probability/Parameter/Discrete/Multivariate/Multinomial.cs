...
namespace StatsSharp.Test.Probability.Parameter.Discrete.Multivariate
{
    [TestClass]
    class Multinomial
    {
        ...
        public void TestConstructor()
        {
            ...
            var mulParameter = new StatsSharp.Probability.Parameter.Discrete.Multivariate.Multinomial(probability, numberOfTrials);
