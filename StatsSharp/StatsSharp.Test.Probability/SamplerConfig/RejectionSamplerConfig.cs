...
namespace StatsSharp.Test.Probability.SamplerConfig
{
    ...
    public class RejectionSamplerConfig
    {
        ...
        {
            var norm = new StatsSharp.Probability.Distribution.Normal();
            ...
            Assert.IsTrue(rejectionSamplerConfig.TargetDistribution.GetType() == typeof(StatsSharp.Probability.Distribution.Normal));
            Assert.IsTrue(rejectionSamplerConfig.TargetDistParameter.GetType() == typeof(StatsSharp.Probability.Parameter.Normal));
            Assert.IsTrue(rejectionSamplerConfig.ProposalDistribution.GetType() == typeof(StatsSharp.Probability.Distribution.T));
