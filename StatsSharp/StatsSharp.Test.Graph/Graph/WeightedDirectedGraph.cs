...
namespace StatsSharp.Test.Graph.Graph
{
    ...
    public class WeightedDirectedGraph
    {
        ...
        public void TestConstructor()
        {
            ...
            var graph = new StatsSharp.Graph.Graph.WeightedDirectedGraph(new List<StatsSharp.Graph.Edge.WeightedEdge>() { edge }, new List<StatsSharp.Graph.Node.Node>() { from, to });
