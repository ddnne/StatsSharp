...
namespace StatsSharp.Test.StatisticalTest
{
    ...
    public class Parametric
    {
        ...
        public void TTestOneSample()
        {
            ...
            var tTest = new StatsSharp.Statistics.StatisticalTest.TestMethod.Parametric.TTestOneSample();
            var result = tTest.Test(new StatsSharp.Statistics.StatisticalTest.NullHypothesis.TTestOneSampleNullHypothesis(samples, popMean));
